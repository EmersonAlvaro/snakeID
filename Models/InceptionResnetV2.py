...
def inception_resnet_A(x):
    ...
    a4 =layers.Conv2D(a4, 384, kernel_size=(1, 1),  activation='linear', padding='same')
...
def inception_resnet_B(x):
    ...
    b2 = layers.Conv2D(b2, 1154, kernel_size=(1, 1), activation='linear',padding='same')
...
def inception_resnet_C(x):
    ...
    c4 = layers.Conv2D(c4, 2048, kernel_size=(1, 1), activation='linear',padding='same')
